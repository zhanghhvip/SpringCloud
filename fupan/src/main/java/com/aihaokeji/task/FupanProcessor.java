...
public class FupanProcessor {
	...
	public void downloadpage(){
		...
		for(Element element : elements2){
			...
			BigDecimal change_ratio = BigDecimal.valueOf(Float.valueOf(stringList.get(0)));
			BigDecimal close_price =  BigDecimal.valueOf(Float.valueOf(stringList.get(1)));
			...
			BigDecimal fdl = BigDecimal.valueOf(Float.valueOf(stringList.get(10).replace('万', ' '))*10000);
			BigDecimal fde = BigDecimal.valueOf(stringList.get(11).contains("万")?Float.valueOf(stringList.get(11).replace('万', ' '))*10000:Float.valueOf(stringList.get(11).replace('亿', ' '))*100000000);
			BigDecimal fdl_vol_ratio =  BigDecimal.valueOf(stringList.get(12).contains("万")?Float.valueOf(stringList.get(12).replace('万', ' '))*10000:Float.valueOf(stringList.get(12)));
			BigDecimal fdl_ltg_ratio =  BigDecimal.valueOf(Float.valueOf(stringList.get(13)));
			Integer kb_num = Integer.parseInt(stringList.get(14));
			BigDecimal ltsz = BigDecimal.valueOf(Float.valueOf(stringList.get(15).replace('亿', ' '))*100000000);
			Integer ss_days = Integer.parseInt(stringList.get(16).replaceAll(",", ""));
